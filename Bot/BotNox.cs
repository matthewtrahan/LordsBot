    ...
    public class BotNox
    {
        ...
        private bool BuildingUpGrade()
        {
            ...
            do
            {
                ...
                //Upgrade button on building, then confirm upgrade
                BuildingUpgrade.BuildingUpGradeButton(handler);
                BuildingUpgrade.ConfirmBuildingUpgrade(handler);
        ...
        private bool BuildingUpGradeSearch()
        {
            ...
            if (BuildingUpgrade.BuildingUpGradeFound(handler)) { return true; }
        ...
        private bool StartResearch()
        {
            ...
            point = ImageProcessing.LocateImageSingle(handler, LordsBot.Properties.Resources.StartResearch, threshold_TEMP);
            if (point.X != 0 && point.Y != 0)
            {
                MouseAction.SendMouseClick(handler, point.X, point.Y);
                Thread.Sleep(delay);
        ...
        private bool isInGame()
        {
            ...
            point = ImageProcessing.LocateImageSingle(handler, LordsBot.Properties.Resources.InGame, threshold);
            if (point.X != 0 && point.Y != 0)
            {
                return true;
            }
